...
logical_exp:  logical_exp_higher logical_or logical_exp  |  logical_exp_higher  set_relations logical_exp | logical_exp_higher ;
...
higher_precedence_exp: higher_precedence_exp higher_operator set_exp_higher 
 		       | set_exp_higher ;
 
set_exp_higher: set_exp_higher set_operators arit_exp_part | arit_exp_part ;
 
arit_exp_part:  logical_not term | term;

term: LP logical_exp RP | primary_exp | set | call_stmt;
